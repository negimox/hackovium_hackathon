...
export default function DashboardStat({
  ...
  return (
    <Card className="relative overflow-hidden border border-border/50 shadow-sm hover:shadow-md transition-shadow duration-300">
      ...
      <CardContent className="flex-1 pt-3 overflow-clip relative">
        <div className="flex items-end justify-between">
          ...
          {tag && (
            <Badge variant="secondary" className="uppercase ml-3 text-xs font-medium">
              {tag}
            </Badge>
          )}
        </div>
        ...
        {description && (
          <div className="justify-between">
            <p className="text-xs font-medium text-muted-foreground tracking-wide mt-2">
              {description}
            </p>
          </div>
        )}
